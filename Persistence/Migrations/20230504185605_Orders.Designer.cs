...
namespace Persistence.Migrations
{
    ...
    [Migration("20230504185605_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Finances.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.Entities.HomePages.HomePageImages", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.Entities.HomePages.Slider", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2023, 5, 4, 23, 26, 4, 578, DateTimeKind.Local).AddTicks(7426),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2023, 5, 4, 23, 26, 4, 584, DateTimeKind.Local).AddTicks(3006),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2023, 5, 4, 23, 26, 4, 584, DateTimeKind.Local).AddTicks(3196),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Domain.Entities.Finances.RequestPay", "RequestPay")
                        .WithMany("Orders")
